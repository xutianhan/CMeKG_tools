...
class medical_ner(object):
    def __init__(self):
        self.NEWPATH = '/Users/guyixun/Documents/PHD/KG-construction/CMeKG_tools/model/medical_ner/model.pkl'
        self.vocab = load_vocab('/Users/guyixun/Documents/PHD/KG-construction/CMeKG_tools/model/medical_ner/vocab.txt')
        self.vocab_reverse = {v: k for k, v in self.vocab.items()}

        self.model = BERT_LSTM_CRF('/Users/guyixun/Documents/PHD/KG-construction/CMeKG_tools/model/medical_ner', tagset_size, 768, 200, 2,
